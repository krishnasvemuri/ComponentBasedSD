...
1.Project Folder with name SWE645_VEMURI_HW3
2.War File with name SWE645_VEMURI_HW3.war
3.Read Me File
...
1.StudentBean.java
2.WinningResultBean.java
3.StudentService.java
4.ZipRest.java

It also contains the web.xml and faces-config.xml
 
To run the project:

1. Unzip the file SWE645_VEMURI_HW3
2. Export SWE645_VEMURI_HW3.war file onto Eclipse 
3. Export the source files and all other required files into elipse
4. Add external jar files required for JSF 2.2 and Restful Services
5. Click RunAs and run it on Tomcat 7.0 server

Link to S3 : https://s3.amazonaws.com/swe645final/index.html
Link to Ec2 :http://ec2-34-230-62-99.compute-1.amazonaws.com/SWE645_VEMURI_HW3/
